...
SELECT wci.addparameter( 'sea surface swell wave significant height', null, null, null, null, null, null, 'm' );
SELECT wci.addparameter( 'sea surface wind wave significant height', null, null, null, null, null, null, 'm' );
SELECT wci.addparameter( 'sea surface wave to direction', null, null, null, null, null, null, 'rad' );
SELECT wci.addparameter( 'sea surface swell wave to direction', null, null, null, null, null, null, 'rad' );
SELECT wci.addparameter( 'sea surface wind wave to direction', null, null, null, null, null, null, 'rad' );
SELECT wci.addparameter( 'sea surface wave period', null, null, null, null, null, null, 's' );
SELECT wci.addparameter( 'sea surface swell wave period', null, null, null, null, null, null, 's' );
SELECT wci.addparameter( 'sea surface wind wave period', null, null, null, null, null, null, 's' );
...
SELECT wci.addparameter( 'height', null, null, null, null, null, null, 'm' );
