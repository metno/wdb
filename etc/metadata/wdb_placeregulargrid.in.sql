...
select wci.addplaceregulargrid('test utm grid',2481,4001,25.000,25.000,400000.0000,7100000.0000,'+proj=utm +zone=33 +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs');
