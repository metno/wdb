...
select wci.addplaceregulargrid('hirlam 10 u',248,400,0.100,0.100,5.8000,-13.2500,'+proj=ob_tran +o_proj=longlat +lon_0=-40 +o_lat_p=22 +a=6367470.0 +no_defs');
select wci.addplaceregulargrid('hirlam 10 v',248,400,0.100,0.100,5.7500,-13.2000,'+proj=ob_tran +o_proj=longlat +lon_0=-40 +o_lat_p=22 +a=6367470.0 +no_defs');
select wci.addplaceregulargrid('hirlam 20',468,378,0.200,0.200,-46.5000,-36.5000,'+proj=ob_tran +o_proj=longlat +lon_0=0 +o_lat_p=25 +a=6367470.0 +no_defs');
