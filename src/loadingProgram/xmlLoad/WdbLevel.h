...
struct WdbLevel
{
    ...
    { };
    WdbLevel( const WdbLevel & level )
              : levelParameter_(level.levelParameter_),
                levelFrom_(level.levelFrom_),
                levelTo_(level.levelTo_),
                levelIndeterminate_(level.levelIndeterminate_) 
    { };
};
