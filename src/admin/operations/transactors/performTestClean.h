...
#ifndef PERFORMTESTCLEAN_H_
#define PERFORMTESTCLEAN_H_
 ...
 */
class PerformTestClean : public pqxx::transactor<>
{
public:
	/**
	 * Default Constructor
	 */
	PerformTestClean( int & ret, std::string wciUser ) :
    	pqxx::transactor<>("PerformTestClean"),
