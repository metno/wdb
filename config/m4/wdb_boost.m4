...
export LDFLAGS
# Hard-coded -lboost_system call. Should be fixed.
LIBS="$LIBS $BOOST_PROGRAM_OPTIONS_LIB $BOOST_DATE_TIME_LIB $BOOST_REGEX_LIB $BOOST_FILESYSTEM_LIB $BOOST_THREAD_LIB -boost_system"
export LIBS
])
