...
(See wdb_feltload_system-test-specification for details)
...
# Paths
export FELTLOAD_PATH=__WDB_PKGLIBDIR__
export FELTWRITE_PATH=__WDB_BUILDDIR__
...
export TEST_FILE=$TMP_PATH/$TESTCASE_FILE.felt
export LOGFILE=$LOG_PATH/$TESTCASE_FILE-feltload.log
rm -f $LOGFILE
