...
{
	result r = t->exec( statementOid_( "above 5 height above reference ellipsoid" ) );
	CPPUNIT_ASSERT( ! r.empty() );
}

void LevelTest::testL1_01B_ValidLevel()
{
	result r = t->exec( statementFloat_( "above 5 height above reference ellipsoid" ) );
	CPPUNIT_ASSERT( ! r.empty() );
}
...
{
	result r = t->exec(statementOid_( "5 TO 10 height above ground"));
	CPPUNIT_ASSERT_EQUAL(result::size_type(1), r.size());
}

void LevelTest::levelRangePoint()
{
	result r = t->exec(statementFloat_( "5 TO 10 height above ground"));
	CPPUNIT_ASSERT_EQUAL(result::size_type(1), r.size());
}

void LevelTest::testL2_01A_Exact()
{
	result r = t->exec( statementOid_( "10 height above reference ellipsoid" ) );

	CPPUNIT_ASSERT_EQUAL( result::size_type(1), r.size() );
	CPPUNIT_ASSERT_EQUAL( size_t(1), count_val( r, "levelparametername", "height above reference ellipsoid" ) );
...
{
	result r = t->exec( statementFloat_( "10 height above reference ellipsoid" ) );
...
{
	result r = t->exec( statementOid_( "below 15 height above reference ellipsoid" ) );

	// we expect several results.
	CPPUNIT_ASSERT( not r.empty() );
	CPPUNIT_ASSERT( count_val( r, "levelparametername", "height above reference ellipsoid" ) );
...
{
	result r = t->exec( statementFloat_( "below 15 height above reference ellipsoid" ) );
...
{
	result r = t->exec( statementOid_( "any 0 height above ground" ) );

	// we expect several results.
	CPPUNIT_ASSERT( not r.empty() );
	CPPUNIT_ASSERT( count_val( r, "levelparametername", "height above ground" ) );
...
{
	result r = t->exec( statementFloat_( "any 0 height above ground" ) );
...
{
	result r = t->exec( statementOid_( "0 height above reference ellipsoid" ) );
}

void LevelTest::testL3_01B_CorrectSpec()
{
	result r = t->exec( statementFloat_( "0 height above reference ellipsoid" ) );
}

void LevelTest::testL3_02A_IncorrectSpec()
{
	CPPUNIT_ASSERT_THROW( t->exec( statementOid_( "any tf TO 0 height above reference ellipsoid" ) ), sql_error );
	// if you use pqxx version 2.6.9, this is correct. The above is correct
	// for version 2.6.8, which is the current debian release of pqxx:
	// CPPUNIT_ASSERT_THROW( t->exec( statement_( "tf", "0", "height above reference ellipsoid", "any" ) ), undefined_column );
}

void LevelTest::testL3_02B_IncorrectSpec()
{
	CPPUNIT_ASSERT_THROW( t->exec( statementFloat_( "any tf TO 0 height above reference ellipsoid" ) ), sql_error );
	// if you use pqxx version 2.6.9, this is correct. The above is correct
	// for version 2.6.8, which is the current debian release of pqxx:
	// CPPUNIT_ASSERT_THROW( t->exec( statement_( "tf", "0", "height above reference ellipsoid", "any" ) ), undefined_column );
}
...
{
	result r = t->exec( statementOid_( "exact 10 height above reference ellipsoid" ) );
...
{
	result r = t->exec( statementFloat_( "exact 10 height above reference ellipsoid" ) );
