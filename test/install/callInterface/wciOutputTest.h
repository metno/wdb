...
#ifndef WCIOUTPUTTEST_H_
#define WCIOUTPUTTEST_H_
...
/**
 * Various tests of expected output and error conditions related to wci.read(),
 * which don't fall into any other category
 */
class wciOutputTest : public AbstractWciTestFixture
{
	CPPUNIT_TEST_SUITE( wciOutputTest );
