...
#ifndef PERFORMANCETESTCONFIGURATION_H_
#define PERFORMANCETESTCONFIGURATION_H_
...
class PerformanceTestConfiguration : public WdbConfiguration
{
public:
	PerformanceTestConfiguration();
	virtual ~PerformanceTestConfiguration();
...
#endif /*PERFORMANCETESTCONFIGURATION_H_*/
